...
// notice that we aren't exporting anything --
// this is because this file will be run when we require 
//it using our config file and then since the model is defined w
//e'll be able to access it from our controller